...
def run():
    ...
    inPath = os.path.join(root, "img")
    outPath = os.path.join(root, "img2")
    ...
    for i in range(len(listName)):
        ...
        devessel.process(os.path.join(outPath, filename))

def test():
    name="im0001.ppm.jpg"
    devessel = DeVessel("./test/img/"+name)
    devessel.process("./test/img/test_bg.jpg")
